...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql="SELECT * FROM admin WHERE username='$username' and personal_password='$password'";
            ...
            <div class="col-xsml-9 col-md-7 col-lg-5 mx-auto">
                <div class="card border-0 shadow rounded-8 my-5">
                  <div class="card-body p-4 p-sm-5">
                    <h5 class="card-title text-center mb-1  fw-blue fs-5">ADMIN LOGIN</h5>
                    <hr class=light></hr>
                    <form action="indexDB.php" method="post">
                      ...
                      <!-- Password -->
                        <div class="form-floating mb-3">
                            ...
                            <input type="password" name="personal_password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>" required>
